...
if __name__ == '__main__':
    ...
    # for ii in range(1):
        ...
        parser.add_argument('--input_size', type=int, default=20, help='input dimension')
        ...
        # for jj in range(1):
            ...
            max_target = np.max(df[columns[jj+1]])
            min_target = np.min(df[columns[jj+1]])
            ...
            data, m, n = df, max_target, min_target
